---------------------------------------------------------------------------
 SPACEBOX 4096 - NEBULA COLLISION
---------------------------------------------------------------------------
 ...
 2. Drag a material (e.g. "Spacebox-Dark") to Skybox Material in the Inspector

 Method 2 - Camera Specific
 1. Select your Camera and then click Component --> Rendering --> Skybox
 2. Drag a material (e.g. "Spacebox-Dark") to Custom Skybox in the Inspector
